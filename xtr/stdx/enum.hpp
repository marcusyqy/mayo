...
struct enum_as_bitmask<Type, std::void_t<decltype(Type::_stdx_enum_as_bitmask)>> : std::is_enum<Type> {};
...
template <typename Type>
[[nodiscard]] constexpr std::enable_if_t<stdx::detail::enum_as_bitmask_v<Type>, Type>
...
template <typename Type>
[[nodiscard]] constexpr std::enable_if_t<stdx::detail::enum_as_bitmask_v<Type>, bool>
    operator!(const Type value) noexcept {
...
template <typename Type>
constexpr std::enable_if_t<stdx::detail::enum_decay_v<Type>, std::underlying_type_t<Type>>
