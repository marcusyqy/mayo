...
public:
    struct iterator {
        ...
        // comparison
        bool operator==(const iterator& e) const noexcept { return value_ == e.value_; }
    ...
    void for_each(stdx::function_ref<void(I)> f) noexcept { std::for_each(std::begin(*this), std::end(*this), f); }
