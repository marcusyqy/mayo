...
bool QueueFamilyProperties::has_compute() const noexcept {
    return properties_.queueFlags & VK_QUEUE_COMPUTE_BIT;
}

bool QueueFamilyProperties::has_graphics() const noexcept {
    return properties_.queueFlags & VK_QUEUE_GRAPHICS_BIT;
}

bool QueueFamilyProperties::has_transfer() const noexcept {
    return properties_.queueFlags & VK_QUEUE_TRANSFER_BIT;
}

bool QueueFamilyProperties::has_protected() const noexcept {
...
bool QueueFamilyProperties ::valid() const noexcept {
    return properties_.queueCount > 0;
}

QueueFamilyProperties::size_type QueueFamilyProperties::size() const noexcept {
