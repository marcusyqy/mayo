...
Messenger::Messenger(VkInstance instance) noexcept : instance_(instance), debug_messenger_(VK_NULL_HANDLE) {
...
Messenger::Messenger(Messenger&& other) noexcept : instance_(VK_NULL_HANDLE), debug_messenger_(VK_NULL_HANDLE){
    *this = std::move(other);
}
