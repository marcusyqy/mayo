...
public:
    Initializer(FunctionPtr on_construct, FunctionPtr on_destruct,
        Ts&&... datas) noexcept
        : on_construct_(on_construct), on_destruct_(on_destruct),
          data_(std::make_tuple(std::forward<Ts&&>(datas)...)) {
    ...
    Initializer(Initializer&& o) noexcept
        : on_construct_(o.on_construct_), on_destruct_(o.on_destruct_),
